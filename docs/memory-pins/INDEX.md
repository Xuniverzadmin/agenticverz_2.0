...
| 2026-02-21 | **PIN-602 HOC API Ledger Wave 2 (FDR) + Publication Expansion** - Added deterministic FDR ledger artifacts (66 rows), built merged HOC ledger (568 rows CUS+FDR), expanded stagetest ledger publication fallback order, and recorded Wave 2 governance evidence. |
