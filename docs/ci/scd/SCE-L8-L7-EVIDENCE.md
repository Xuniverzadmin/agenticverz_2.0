# SCE Evidence: L8 to L7 Boundary

**Generated:** 2025-12-31T20:24:08.478532+00:00
...
|-----------|---------|------|------|
| backend/tests/test_m10_production_hardening.py | backend/scripts/ops/m10_retention_cleanup.py | import | 540 |
| backend/tests/test_integration.py | backend/app/cli.py | import | 426 |
...
| observed_not_declared | Pattern 'call to publish matches signal pattern' observed bu | HIGH |
| observed_not_declared | Pattern 'call to SlackSendSkill matches signal pattern' obse | MEDIUM |
| observed_not_declared | Pattern 'call to EmailSendSkill matches signal pattern' obse | MEDIUM |
| observed_not_declared | Pattern 'call to SlackSendSkill matches signal pattern' obse | MEDIUM |
| observed_not_declared | Pattern 'call to SlackSendSkill matches signal pattern' obse | MEDIUM |
| observed_not_declared | Pattern 'call to EmailSendSkill matches signal pattern' obse | MEDIUM |
