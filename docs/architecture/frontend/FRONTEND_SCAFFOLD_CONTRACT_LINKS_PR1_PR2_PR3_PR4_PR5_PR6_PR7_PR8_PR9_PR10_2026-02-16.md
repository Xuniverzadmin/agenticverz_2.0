# FRONTEND_SCAFFOLD_CONTRACT_LINKS_PR1_PR2_PR3_PR4_PR5_PR6_PR7_PR8_PR9_PR10_2026-02-16

## Purpose
Establish the frontend scaffold baseline using backend-frozen facade contracts for the first ten read vertical slices.
...
10. Account users list vertical slice (PR-10):
- Contract: `backend/app/hoc/docs/architecture/usecases/PR10_ACCOUNT_USERS_LIST_FACADE_CONTRACT_ADDENDUM_2026-02-16.md`
- Endpoint: `GET /hoc/api/cus/account/users/list`
...
10. `/account/members` page backed by `/account/users/list`.
