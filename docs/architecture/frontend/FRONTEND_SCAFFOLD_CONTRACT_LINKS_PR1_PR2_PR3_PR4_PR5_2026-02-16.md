# FRONTEND_SCAFFOLD_CONTRACT_LINKS_PR1_PR2_PR3_PR4_PR5_2026-02-16

## Purpose
Establish the frontend scaffold baseline using backend-frozen facade contracts for the first five read vertical slices.
...
- Issue ledger: `backend/app/hoc/docs/architecture/usecases/PR4_CONTROLS_LIST_FACADE_ISSUE_LEDGER_2026-02-16.md`
...
- Issue ledger: `backend/app/hoc/docs/architecture/usecases/PR5_LOGS_REPLAY_FEED_FACADE_ISSUE_LEDGER_2026-02-16.md`
...
4. `/controls` page (read-only, topic list via `/list?topic=...`).
5. `/replay` page backed by `/logs/list?topic=...` + run-specific drilldown.
6. Shared error/loading/empty shell states.
