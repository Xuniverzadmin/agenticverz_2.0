...
ENDPOINT_MAP = {
    ...
    # POLICIES - Thresholds
    "POL-LIM-CTR-O1": ("/policy-layer/risk-ceilings", "policies.risk_ceilings"),
    "POL-LIM-CTR-O2": ("/cost/budgets", "policies.budgets_list"),
    "POL-LIM-CTR-O3": ("/api/v1/tenants/tenant/quota/runs", "policies.quota_runs"),
    "POL-LIM-CTR-O4": ("/api/v1/tenants/tenant/quota/tokens", "policies.quota_tokens"),
    "POL-LIM-CTR-O5": ("/policy-layer/cooldowns", "policies.cooldowns_list"),
    # POLICIES - Usage
...
PANEL_NAMES = {
    ...
    "POL-LIM-CTR-O1": "Risk Ceilings",
    "POL-LIM-CTR-O2": "Budget List",
    "POL-LIM-CTR-O3": "Run Quotas",
    "POL-LIM-CTR-O4": "Token Quotas",
    "POL-LIM-CTR-O5": "Cooldowns",
