...
# Product: system-wide
# AUDIENCE: INTERNAL
# Role: Smoke tests for HOC Identity API route scaffolds
# Reference: HOC_AUTH_CLERK_REPLACEMENT_DESIGN_V1_2026-02-21.md

"""
Identity API Route Smoke Tests

Validates that all 8 scaffold endpoints:
1. Are registered in the router.
2. Return 501 Not Implemented (scaffold behavior).
...
class TestScaffoldResponses:
    """All scaffold endpoints return 501 Not Implemented."""
