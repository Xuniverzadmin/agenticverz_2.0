...
def upgrade() -> None:
    ...
    op.create_index("ix_memory_pins_tenant_key", "memory_pins", ["tenant_id", "key"], unique=True, schema="system")
    ...
    op.create_index("ix_memory_pins_tenant_created", "memory_pins", ["tenant_id", "created_at"], schema="system")
