...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', sa.String(50), nullable=False, server_default='active'),  # active, canceled, past_due, trialing
    ...
    op.create_table(
        ...
        # Status
        sa.Column('status', sa.String(50), nullable=False, server_default='available'),  # available, beta, coming_soon, deprecated
    ...
    op.create_table(
        ...
        # Status
        sa.Column('status', sa.String(50), nullable=False, server_default='queued'),  # queued, running, completed, failed
