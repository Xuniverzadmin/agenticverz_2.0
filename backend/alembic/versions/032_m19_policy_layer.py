...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        ),  # action_block, pattern_block, escalation_required, hard_stop, cooldown
    ...
    op.create_table(
        ...
        sa.Column(
            "constraint_type", sa.String(50), nullable=False
        ),  # no_coercion, no_fabrication, no_manipulation, transparency
        ...
        sa.Column(
            "transparency_threshold", sa.Float, nullable=True
        ),  # 0.0-1.0, decisions must be explainable above this
        # Enforcement
