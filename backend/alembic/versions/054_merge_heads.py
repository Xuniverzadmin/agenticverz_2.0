...
- 050_decision_records_causal_binding (decision records feature)
...
Revises: 050_decision_records_causal_binding, 053_pb_s1_retry
...
down_revision = ("050_decision_records_causal_binding", "053_pb_s1_retry")
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    - alembic downgrade 050_decision_records_causal_binding
