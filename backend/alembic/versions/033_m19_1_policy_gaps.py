...
def upgrade() -> None:
    ...
    op.add_column("violations", sa.Column("severity_class", sa.String(50), nullable=True), schema="policy")
    op.add_column("violations", sa.Column("recoverability", sa.String(50), nullable=True), schema="policy")
    op.add_column(
        "violations", sa.Column("action_chain_depth", sa.Integer, nullable=True, server_default="0"), schema="policy"
    )
    op.add_column(
        "violations",
    ...
    op.add_column("violations", sa.Column("temporal_window_seconds", sa.Integer, nullable=True), schema="policy")
    op.add_column("violations", sa.Column("temporal_metric_value", sa.Float, nullable=True), schema="policy")
    op.add_column("violations", sa.Column("recommended_action", sa.String(50), nullable=True), schema="policy")

    # Add policy version tracking to evaluations
    op.add_column("evaluations", sa.Column("policy_version", sa.String(50), nullable=True), schema="policy")
    op.add_column("evaluations", sa.Column("policy_hash", sa.String(64), nullable=True), schema="policy")
    op.add_column(
        "evaluations",
    ...
    op.add_column(
        "evaluations", sa.Column("dependencies_checked", sa.Integer, nullable=True, server_default="0"), schema="policy"
    )
    op.add_column(
        "evaluations", sa.Column("conflicts_detected", sa.Integer, nullable=True, server_default="0"), schema="policy"
    )
