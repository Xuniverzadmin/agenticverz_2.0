# Tests for Skills Registry and Skills
# Run with: pytest backend/app/skills/test_skills.py -v
...
class TestSkillRegistry:
    ...
    def test_get_skill_manifest(self):
        ...
        from .registry import get_skill_manifest
...
class TestHttpCallSkill:
    ...
    @pytest.mark.asyncio
    async def test_execute_local_url(self):
        """HttpCallSkill handles local URLs."""
        from .http_call import HttpCallSkill
        skill = HttpCallSkill(allow_external=False)
