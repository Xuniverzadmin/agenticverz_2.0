...
router = APIRouter(prefix="/founder/contracts", tags=["founder-review"])
...
async def submit_review(
    ...
    # TODO: Get founder ID from auth context
    # For now, use a placeholder. In production, this comes from
    # the authenticated token (FounderToken.founder_id)
    founder_id = "founder_placeholder"
