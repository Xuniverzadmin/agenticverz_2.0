...
# Role: Incident domain write operations with audit (L4 facade over L6 driver)
# Callers: customer_incidents_adapter.py (L3)
# Allowed Imports: L6 (drivers only, NOT ORM models), L4 (AuditLedgerService)
# Forbidden Imports: L1, L2, L3, L5, sqlalchemy, sqlmodel
# Reference: PIN-281, PIN-413, PHASE2_EXTRACTION_PROTOCOL.md
#
# GOVERNANCE NOTE:
# This L4 engine delegates DB operations to IncidentWriteDriver (L6).
