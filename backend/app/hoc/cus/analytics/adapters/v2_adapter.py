...
# Location: hoc/cus/analytics/adapters/v2_adapter.py
"""
...
Adapter responsibility: shape, transport, provenance, context binding.
...
class CostSimV2Adapter:
    ...
    def _estimate_step_v2(self, step_index: int, step: Dict[str, Any]) -> V2StepEstimate:
        ...
        Adapter no longer contains estimation logic.
        """
        # L5 engine import (migrated to HOC per SWEEP-44)
    ...
    def _compare_results(self, v1: SimulationResult, v2: V2SimulationResult) -> ComparisonResult:
        ...
        Adapter only handles shape/transport, not classification thresholds.
        """
        # L5 engine import (migrated to HOC per SWEEP-44)
        ...
        # Map L4 verdict to adapter ComparisonVerdict
        verdict_map = {
        ...
        # Calculate duration delta (adapter shape responsibility - not a policy decision)
