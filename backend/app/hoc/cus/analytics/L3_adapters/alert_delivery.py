...
#
# GOVERNANCE NOTE:
# This L3 adapter provides ONLY HTTP delivery functionality.
...
logger = logging.getLogger("nova.analytics.L3_adapters.alert_delivery")
...
class AlertDeliveryAdapter:
    """
    L3 adapter for HTTP alert delivery.
