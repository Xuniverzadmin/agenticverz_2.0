...
#   Subscribes: none
# Data Access:
#   Reads: config, model coefficients
#   Writes: provenance log
# Role: Cost simulation V2 adapter (translation layer + V1 comparison)
# Callers: sandbox_engine, datasets_engine, canary_engine
# Allowed Imports: L5, L6
# Forbidden Imports: L1, L2, L3, sqlalchemy (runtime)
# Reference: PIN-513, PIN-254 Phase B Fix
"""
...
class CostSimV2Adapter:
    ...
    def _get_coefficients(self, skill_id: str) -> Dict[str, float]:
        ...
        """
        from app.hoc.cus.analytics.L5_engines.cost_model import get_skill_coefficients
    ...
    def _estimate_step_v2(self, step_index: int, step: Dict[str, Any]) -> V2StepEstimate:
        ...
        L5 no longer contains estimation logic.
        """
        from app.hoc.cus.analytics.L5_engines.cost_model import estimate_step_cost
    ...
    def _compare_results(self, v1: SimulationResult, v2: V2SimulationResult) -> ComparisonResult:
        ...
        L5 only handles shape/transport, not classification thresholds.
        """
        from app.hoc.cus.analytics.L5_engines.cost_model import classify_drift
        ...
        # Map L4 verdict to L5 ComparisonVerdict
        verdict_map = {
        ...
        # Calculate duration delta (L5 shape responsibility - not a policy decision)
