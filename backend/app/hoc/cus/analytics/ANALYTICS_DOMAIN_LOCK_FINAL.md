...
| 2026-01-24 | 1.2.0 | **Phase 3 Directory Restructure** — 2 L5 engine files (killswitch.py, manager.py) relocated from L6_drivers/ to L5_engines/ based on content analysis (no DB ops). PIN-470. | Claude |
