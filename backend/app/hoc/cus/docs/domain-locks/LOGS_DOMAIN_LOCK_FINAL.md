...
| 2026-01-24 | 1.5.0 | **Phase 3 Directory Restructure** — 6 L5 engine files relocated from L6_drivers/ to L5_engines/ based on content analysis (no DB ops). PIN-470. | Claude |
