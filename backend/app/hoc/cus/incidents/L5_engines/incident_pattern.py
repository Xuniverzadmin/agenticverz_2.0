...
# NOTE: Demoted incident_pattern_engine.py → incident_pattern.py (2026-02-08)
#       Orphan demotion — no spine pairing, remove _engine suffix
#
...
from app.hoc.cus.incidents.L6_drivers.incident_pattern_driver import (
