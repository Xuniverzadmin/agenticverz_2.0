# Layer: L5 — Domain Schema (Policy)
# AUDIENCE: CUSTOMER
# Product: ai-console
# Role: Severity decision policy — pure stateless logic for incident severity
# Callers: incident_aggregator.py (L6), incident engines
# Reference: PIN-507 (Law 1 remediation — extracted from incident_severity_engine.py)
# artifact_class: CODE

"""
Incident Severity Policy (L5 Schema)
...
class IncidentSeverityEngine:
    """
    Severity decision engine for incidents.
