...
# AUDIENCE: CUSTOMER
# Product: ai-console
# Location: hoc/cus/api_keys/L5_engines/email_verification.py
# Temporal:
#   Trigger: api
...
# Allowed Imports: L5, L6 (Redis client is L6)
...
# Reclassified to L5 because it contains domain-specific verification
