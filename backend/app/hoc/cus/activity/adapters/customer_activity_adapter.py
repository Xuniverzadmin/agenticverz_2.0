...
# Role: Customer activity boundary adapter (L2 → L5)
...
class CustomerActivityAdapter:
    """
    Adapter for customer activity operations.
    ...
    async def list_activities(
        ...
        # Transform L5 DTOs to adapter customer-safe DTOs
    ...
    def _to_customer_summary(self, summary: RunSummaryResult) -> CustomerActivitySummary:
        """
        Transform L5 RunSummaryResult to adapter CustomerActivitySummary.
    ...
    def _to_customer_detail(self, detail: RunDetailResult) -> CustomerActivityDetail:
        """
        Transform L5 RunDetailResult to adapter CustomerActivityDetail.
...
def get_customer_activity_adapter() -> CustomerActivityAdapter:
    ...
    Reference: ACTIVITY Domain Qualification (L2→L5 pattern)
    """
