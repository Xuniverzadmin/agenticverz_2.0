...
# Role: Policy evaluation boundary adapter (L2 → L4)
...
# This adapter is TRANSLATION ONLY. No branching, no thresholds,
...
# F-P-RULE-3: Adapter Is Translation Only - no branching, no thresholds
...
L2 (API) → L4 (command) → L5 (workflow execution)
...
class PolicyAdapter:
    ...
    F-P-RULE-3: Adapter Is Translation Only
    """
    ...
    def record_approval_created(self, policy_type: str) -> None:
        ...
        This method delegates to L4 for metric emission.
...
def get_policy_adapter() -> PolicyAdapter:
    ...
    Reference: PIN-258 Phase F-3 (F-P-RULE-3: Adapter Is the Only Entry)
    """
