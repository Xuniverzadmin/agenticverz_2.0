...
# NOTE: Renamed logs_read_service.py → logs_read_engine.py (2026-01-24)
#       per BANNED_NAMING rule (*_service.py → *_engine.py)
#       Reclassified L4→L5 - Per HOC topology, engines are L5 (business logic)
#
# GOVERNANCE NOTE:
# This L5 engine provides READ operations for the Logs/Traces domain.
# All log/trace reads must go through this engine.
...
# L6 imports (allowed)
from app.hoc.cus.logs.L5_engines.traces_models import TraceRecord, TraceSummary
