...
#   Subscribes: none
# Data Access:
#   Reads: traces, trace_steps (SQLite)
#   Writes: traces, trace_steps (SQLite)
# Database:
#   Scope: domain (logs)
#   Models: traces, trace_steps (SQLite)
# Role: Trace store abstraction (SQLite + in-memory)
# Callers: API routes, services, workers
