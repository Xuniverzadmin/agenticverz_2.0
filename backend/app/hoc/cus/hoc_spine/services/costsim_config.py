...
#   Subscribes: none
# Data Access:
#   Reads: none (environment variables only)
#   Writes: none
# Role: CostSim V2 configuration (env vars)
# Callers: controls L6 drivers, analytics L5 engines
# Allowed Imports: stdlib only
# Forbidden Imports: L5, L6, L7, sqlalchemy
# Reference: PIN-521 (extracted from analytics/L5_engines/config_engine.py)

"""
CostSim V2 Configuration - HOC Spine Shared Service
