...
#   Writes: none
# Role: S1 Retry backoff envelope declaration — shared utility for coordinators
# Callers: anomaly_incident_coordinator (L4), optimization coordinators (L4)
# Allowed Imports: optimization.envelope (shared infra)
# Forbidden Imports: L1, L2, L6, sqlalchemy (runtime)
# Reference: PIN-470, PIN-513 Wiring Plan #3
# artifact_class: CODE
