...
# Role: Customer killswitch boundary adapter (L2 → L4)
# Callers: guard.py (L2)
# Allowed Imports: L4
...
"""
Customer Killswitch Adapter (L2)

This adapter sits between L2 (guard.py API) and L4 services.

L2 (Guard API) → L4 (CustomerKillswitchReadService, GuardWriteService)
...
# Was: from app.hoc.cus.general.L5_controls.engines.guard_write_engine import GuardWriteService
# Reason: cus/general/ abolished per PIN-485. GuardWriteService migrated to hoc_spine.
from app.hoc.hoc_spine.authority.guard_write_engine import GuardWriteService
from app.hoc.cus.controls.L5_engines.customer_killswitch_read_engine import (
