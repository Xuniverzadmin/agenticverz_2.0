...
# NOTE: Renamed alert_fatigue.py → alert_fatigue_engine.py (2026-01-31) per BANNED_NAMING rule
# AUDIENCE: CUSTOMER
# Temporal:
#   Trigger: worker/api
#   Execution: sync
...
#   Subscribes: none
# Data Access:
#   Reads: Redis (alert state via driver)
#   Writes: none
...
Usage:
    from app.hoc.cus.controls.L5_engines.alert_fatigue_engine import get_alert_fatigue_controller
