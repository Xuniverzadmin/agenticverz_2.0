...
#   app.hoc.cus.general.L6_drivers.cus_health_driver
#
...
#
# Old: from app.hoc.cus.general.L5_engines.cus_health_shim import CusHealthService
# New: from app.hoc.cus.general.L6_drivers.cus_health_driver import CusHealthDriver
#
# =============================================================================
...
from app.hoc.cus.general.L6_drivers.cus_health_driver import (
    CusHealthDriver,
...
warnings.warn(
    ...
    "from app.hoc.cus.general.L6_drivers.cus_health_driver import CusHealthDriver",
    DeprecationWarning,
    stacklevel=2,
)
