...
# F-W-RULE-4: L3 Adapter Is the Only Entry - L2 calls only this file.
...
class WorkersAdapter:
    ...
    def calculate_cost_cents(
        ...
        This L3 method delegates to L4 for cost calculation.
    ...
    def convert_brand_request(self, brand_req: Any) -> Any:
        ...
        This L3 method delegates to L4 for schema conversion.
