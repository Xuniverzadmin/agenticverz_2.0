...
# NOTE: Renamed bridges.py → bridges_engine.py (2026-01-31) per BANNED_NAMING rule
# AUDIENCE: CUSTOMER
# Temporal:
#   Trigger: api|worker
#   Execution: sync
...
if TYPE_CHECKING:
    from .dispatcher_engine import IntegrationDispatcher
...
from app.hoc.cus.integrations.L6_drivers.bridges_driver import record_policy_activation
...
# =============================================================================
# NOTE: PolicyActivationAudit moved to schemas/audit_schemas.py
# NOTE: record_policy_activation moved to drivers/bridges_driver.py
# =============================================================================
