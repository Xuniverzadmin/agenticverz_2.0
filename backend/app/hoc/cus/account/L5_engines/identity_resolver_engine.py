...
# NOTE: Renamed identity_resolver.py → identity_resolver_engine.py (2026-01-31) per BANNED_NAMING rule
# AUDIENCE: CUSTOMER
# Product: system-wide
# Temporal:
#   Trigger: api
...
#   Subscribes: none
# Data Access:
#   Reads: none (external provider lookup only)
#   Writes: none
...
# NOTE: Reclassified L6→L5 (2026-01-24) - pure identity logic, no DB ops
...
from app.hoc.int.platform.iam.engines.iam_service import (
