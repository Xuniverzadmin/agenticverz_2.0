...
# Canonical Location: app/hoc/cus/general/L5_engines/fatigue_controller.py
#
...
#
# For new code, use:
#   from app.hoc.cus.general.L5_engines.fatigue_controller import (
#       get_alert_fatigue_controller,
#       AlertFatigueController,
#   )
#
# Reference: HOC_general_deep_audit_report.md
# ==============================================================================
...
#   Trigger: worker/api
#   Execution: sync
# Role: Alert deduplication and fatigue control [DEPRECATED]
