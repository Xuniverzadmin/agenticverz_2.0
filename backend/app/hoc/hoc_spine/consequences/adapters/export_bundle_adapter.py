...
# Violates spine constitutional boundary. Will be re-wired during L1 design
# via orchestrator-passed consequence data or protocol interface.
# Previous import:
#   from app.hoc.cus.logs.L6_drivers.export_bundle_store import (
#       ExportBundleStore, IncidentSnapshot, RunSnapshot,
#       TraceSummarySnapshot, TraceStepSnapshot, get_export_bundle_store)
# TODO(L1): Inject ExportBundleStore via constructor or orchestrator consequence context
...
class ExportBundleAdapter:
    ...
    def __init__(self, store: Optional[ExportBundleStore] = None):
        """Initialize with optional store (for testing)."""
        self._store = store or get_export_bundle_store()
