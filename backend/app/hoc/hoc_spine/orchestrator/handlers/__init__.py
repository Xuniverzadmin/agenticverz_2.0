...
if TYPE_CHECKING:
    from app.hoc.hoc_spine.orchestrator.operation_registry import OperationRegistry
...
def register_all_handlers(registry: "OperationRegistry") -> None:
    ...
    from app.hoc.hoc_spine.orchestrator.handlers import overview_handler
    from app.hoc.hoc_spine.orchestrator.handlers import account_handler
    from app.hoc.hoc_spine.orchestrator.handlers import analytics_handler
    from app.hoc.hoc_spine.orchestrator.handlers import api_keys_handler
    from app.hoc.hoc_spine.orchestrator.handlers import incidents_handler
    from app.hoc.hoc_spine.orchestrator.handlers import integrations_handler
    ...
    from app.hoc.hoc_spine.orchestrator.handlers import logs_handler
    ...
    from app.hoc.hoc_spine.orchestrator.handlers import controls_handler

    controls_handler.register(registry)  # controls.query, .thresholds

    # Phase A.4 — Activity domain (4 operations: activity)
    from app.hoc.hoc_spine.orchestrator.handlers import activity_handler
    ...
    from app.hoc.hoc_spine.orchestrator.handlers import policies_handler
