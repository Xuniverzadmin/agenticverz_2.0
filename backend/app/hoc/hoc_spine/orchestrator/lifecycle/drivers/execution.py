...
class DataIngestionExecutor:
    ...
    async def _get_connector(
        ...
        try:
            ...
            # Previous: from app.hoc.cus.integrations.L6_drivers.connector_registry import get_connector
            # TODO(L1): Inject connector lookup via orchestrator execution context
            raise NotImplementedError("Connector lookup pending L1 re-wiring")
        except Exception as e:
            logger.warning(
