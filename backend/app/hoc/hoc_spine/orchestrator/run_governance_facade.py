...
class RunGovernanceFacade:
    ...
    def _lessons(self):
        ...
        if self._lessons_engine is None:
            ...
            # Previous: from app.hoc.cus.policies.L5_engines.lessons_engine import get_lessons_learned_engine
            # TODO(L1): Inject lessons engine via orchestrator context
            raise NotImplementedError("Lessons engine pending L1 re-wiring")
    ...
    def create_policy_evaluation(
        ...
        try:
            # CROSS-DOMAIN IMPORT — BROKEN INTENTIONALLY (2026-01-30)
            # Previous: from app.hoc.cus.incidents.L5_engines.policy_violation_service import create_policy_evaluation_sync
            # TODO(L1): Inject policy evaluation service via orchestrator context
            raise NotImplementedError("Policy evaluation service pending L1 re-wiring")
