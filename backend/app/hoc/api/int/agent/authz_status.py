...
Endpoints:
    GET /int/authz/status - Current authorization configuration
    GET /int/authz/mappings - All M7→M28 mappings
"""
...
router = APIRouter(prefix="/int/authz", tags=["Internal - Authorization"])
