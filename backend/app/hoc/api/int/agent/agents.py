...
# - POST /jobs/{id}/claim - Worker claims item
# - POST /jobs/{id}/items/{item_id}/complete - Complete item
# - GET/PUT /blackboard/{key} - Blackboard operations
# - POST /blackboard/{key}/lock - Lock operations
# - POST /agents/register - Register agent
# - POST /agents/{instance_id}/heartbeat - Heartbeat
# - GET/POST /agents/{instance_id}/messages - Messages
#
# M15.1 SBA Endpoints:
# - POST /sba/validate - Validate SBA schema
...
async def simulate_job(
    ...
    return SimulateJobResponse(
        ...
        credits_per_item=d["credits_per_item"],
        item_count=d["item_count"],
        estimated_duration_seconds=d["estimated_duration_seconds"],
        budget_check=d["budget_check"],
        risks=d["risks"],
        warnings=d["warnings"],
...
async def get_job(job_id: str):
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id="system",
            params={"method": "get", "job_id": job_id},
        ),
    )
    if not result.success:
...
async def cancel_job(job_id: str):
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id="system",
            params={"method": "cancel", "job_id": job_id},
        ),
    )
    if not result.success:
        raise HTTPException(status_code=400, detail=result.error)
...
async def claim_item(
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id="system",
            params={"method": "claim_item", "job_id": job_id, "worker_instance_id": worker_instance_id},
        ),
    )
    if not result.success:
        raise HTTPException(status_code=500, detail=result.error)
...
async def complete_item(
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id="system",
            params={"method": "complete_item", "job_id": job_id, "item_id": item_id, "output": request.output},
        ),
    )
    if not result.success:
        raise HTTPException(status_code=400, detail=result.error)
...
async def put_blackboard(key: str, request: BlackboardWriteRequest):
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id="system",
            params={"method": "set", "key": key, "value": request.value, "ttl": request.ttl},
        ),
    )
    if not result.success:
        raise HTTPException(status_code=500, detail=result.error)
...
async def increment_blackboard(key: str, request: BlackboardIncrementRequest):
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id="system",
            params={"method": "increment", "key": key, "amount": request.amount},
        ),
    )
    if not result.success:
        raise HTTPException(status_code=500, detail=result.error)
...
async def agent_heartbeat(instance_id: str):
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id="system",
            params={"method": "heartbeat", "instance_id": instance_id},
        ),
    )
    if not result.success:
...
async def deregister_agent(instance_id: str):
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id="system",
            params={"method": "deregister", "instance_id": instance_id},
        ),
    )
    if not result.success:
        raise HTTPException(status_code=404, detail=result.error)
...
async def get_agent(instance_id: str):
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id="system",
            params={"method": "get", "instance_id": instance_id},
        ),
    )
    if not result.success:
        if result.error_code == "NOT_FOUND":
...
async def list_agents(
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id="system",
            params={"method": "list", "agent_id": agent_id, "job_id": job_id, "status": status},
        ),
    )
    if not result.success:
        raise HTTPException(status_code=500, detail=result.error)
...
async def mark_message_read(instance_id: str, message_id: str):
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id="system",
            params={"method": "mark_read", "message_id": message_id},
        ),
    )
    if not result.success:
        raise HTTPException(status_code=400, detail=result.error)
...
async def get_agent_activity_costs(
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id=x_tenant_id,
            params={"method": "costs", "agent_id": agent_id},
        ),
    )
    if not result.success:
        raise HTTPException(status_code=500, detail=result.error)
    ...
    return ActivityCostsResponse(
        agent_id=d["agent_id"],
        workers=[WorkerCostMetrics(**w) for w in d["workers"]],
        total_cost_level=d["total_cost_level"],
...
async def get_agent_activity_spending(
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id=x_tenant_id,
            params={"method": "spending", "agent_id": agent_id, "period": period},
        ),
    )
    if not result.success:
        raise HTTPException(status_code=500, detail=result.error)
...
async def get_agent_activity_retries(
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id=x_tenant_id,
            params={"method": "retries", "agent_id": agent_id, "limit": limit},
        ),
    )
    if not result.success:
        raise HTTPException(status_code=500, detail=result.error)
    ...
    return ActivityRetriesResponse(
        agent_id=d["agent_id"],
        retries=[RetryEntryResponse(**r) for r in d["retries"]],
...
async def get_agent_activity_blockers(
    ...
    result = await registry.execute(
        ...
        OperationContext(
            session=None,
            tenant_id=x_tenant_id,
            params={"method": "blockers", "agent_id": agent_id},
        ),
    )
    if not result.success:
        raise HTTPException(status_code=500, detail=result.error)
    ...
    return ActivityBlockersResponse(
        agent_id=d["agent_id"],
        blockers=[BlockerEntry(**b) for b in d["blockers"]],
        blocked=d["blocked"],
        timestamp=d["timestamp"],
    )
