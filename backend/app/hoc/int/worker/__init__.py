...
# Note: Direct imports like `from app.hoc.int.worker import WorkerPool` will still fail
# Use `from app.hoc.int.worker import get_worker_pool; WorkerPool = get_worker_pool()` instead
# Or import directly: `from app.hoc.int.worker.pool import WorkerPool`
