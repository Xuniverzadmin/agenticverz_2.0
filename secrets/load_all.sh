...
echo "  - Voyage AI (Embeddings)"
echo "  - Resend Email"
echo "  - PostHog Analytics"
echo "  - Trigger.dev Jobs"
echo "  - Cloudflare Workers"
echo "  - Microsoft OAuth (Outlook/Calendar)"
echo "  - Google OAuth (Gmail/Calendar)"
echo ""
echo "Verify with: env | grep -E 'NEON|CLERK|RESEND|POSTHOG|TRIGGER|CLOUDFLARE|OPENAI|VOYAGE|MICROSOFT|GOOGLE'"
