...
# Pattern: app/hoc/cus/overview/facades/overview_facade.py
...
Usage:
    from app.hoc.cus.overview.facades.overview_facade import get_overview_facade
...
from app.hoc.cus.overview.drivers.overview_facade_driver import (
...
logger = logging.getLogger("nova.hoc.cus.overview.facades")
