...
# Callers: trace store
# Allowed Imports: L6, L7 (stdlib, re)
# Forbidden Imports: L1, L2, L3, L4, sqlalchemy, sqlmodel
# Reference: Trace System
# NOTE: Reclassified L6→L5 (2026-01-24) - Pure data transformation, not SQL driver
#       Remains in drivers/ per Layer ≠ Directory principle
#
# INTENT FREEZE (2026-01-24):
# This file implements PII REDACTION EXECUTION using a fixed list of regex patterns.
# It does NOT contain business decisions. The patterns (passwords, credit cards, tokens, etc.)
# are SECURITY RULES defined by industry-standard PII categories, not business policy.
# The decision "what constitutes PII?" is a compliance standard (GDPR/SOC2), not a runtime choice.
# This engine only EXECUTES pattern matching and string replacement on input data.
# Layer L5 compliance: Pure data transformation with fixed rules, no policy evaluation.
