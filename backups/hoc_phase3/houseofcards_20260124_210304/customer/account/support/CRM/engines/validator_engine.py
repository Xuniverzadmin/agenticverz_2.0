...
# Reference: PIN-287, VALIDATOR_LOGIC.md, ACCOUNT_PHASE2.5_IMPLEMENTATION_PLAN.md
#
# RENAME NOTE (2026-01-24):
# Renamed from validator_service.py to validator_engine.py
# to comply with HOC naming conventions (*_service.py is BANNED).
#
# ==============================================================================
